...
public class Ingredient extends EntityBase {
	...
	private Integer ingredientOrger;
	...
	public Integer getIngredientOrger() {
		return ingredientOrger;
	}
	public void setIngredientOrger(Integer ingredientOrger) {
		this.ingredientOrger = ingredientOrger;
	}
	...
	public String toString() {
		...
		if (Objects.nonNull(unit) && Objects.nonNull(unit.getUnitId())) {
		 ...
		 if(Objects.nonNull(ingredientName)) {
